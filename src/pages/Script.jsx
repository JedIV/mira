const steps = [
  ...
  { saying: 'This is Dataiku Agent Management.', showing: 'Reveal the Dashboard. Stats strip: 4,127 total agents, platform tiles, most active agents table, behavior status breakdown. Let it breathe.', time: '~6s' },
  ...
  { saying: 'More than 700 agents — all technically healthy — are showing behavioral shifts. The KYC agent\'s escalation rate has climbed from 8% to 23%. Manual check volumes are up 62%. Credit applications are taking twice as long.', showing: 'Business Impact screen. 1,829 stable, 574 with shifts detected, 23 significant shifts. KYC Verification Agent visible with red "Significant Shift" badge.', time: '~18s' },
  { saying: 'Let\'s drill into that KYC agent. David\'s team can see exactly what changed — the root cause is an address verification model regression that\'s sending non-US passport applications to manual review.', showing: 'Click into KYC Agent Behavior page. Outcome shift alert banner. Four metric cards: escalation 8%→23%, address failures 72%, confidence 0.91→0.74, processing time 2.1→4.2 days.', time: '~12s' },
  ...
  { saying: 'David used to have agents everywhere and answers nowhere. Now he walks into the board meeting with proof — that the bank\'s agent strategy is delivering value, and the risk is under control.', showing: 'Return to Dashboard. Platform tiles, most active agents, behavior status strip.', time: '~8s' },
...
const screens = [
  ...
  { screen: 'Operational Health', duration: '~16s', route: '/performance/operational' },
  { screen: 'Business Impact', duration: '~18s', route: '/performance/business' },
  { screen: 'KYC Agent Behavior + Decision Flow', duration: '~24s', route: '/agents/kyc-agent-016/behavior' },
  { screen: 'Behavior Trends', duration: '~12s', route: '/usage-trends' },
